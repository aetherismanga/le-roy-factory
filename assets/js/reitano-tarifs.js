  ...
  function appendCard() {
    ...
    card.innerHTML = `
      ...
      <div style="display:flex;flex-direction:column;gap:.75rem;">
        <div class="pro-info-row"><div><strong style="display:block;font-size:.85rem;color:#1A2530;">Tarif général 2026</strong><span style="font-size:.75rem;color:#666;">Tarif professionnel Reitano Rubinetterie 2026.</span></div><a href="${TARIF_GENERAL_URL}" target="_blank" rel="noopener" class="btn btn-outline" style="font-size:.75rem;padding:.4rem .8rem;white-space:nowrap;">Tarifs</a></div>
        <div class="pro-info-row"><div><strong style="display:block;font-size:.85rem;color:#1A2530;">Tarif Accessoires 2026</strong><span style="font-size:.75rem;color:#666;">Tarif professionnel des accessoires Reitano.</span></div><a href="${TARIF_ACCESSOIRES_URL}" target="_blank" rel="noopener" class="btn btn-outline" style="font-size:.75rem;padding:.4rem .8rem;white-space:nowrap;">Tarifs</a></div>
