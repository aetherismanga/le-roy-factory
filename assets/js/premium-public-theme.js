(() => {
  ...
  addStylesheet('lrf-logo-scale-v9-css', 'assets/css/lrf-logo-scale-v9.css?v=20260915-brand-final3');
  ...
  const setBrand = () => {
    ...
    if (favicon) {
      favicon.href = 'assets/brand-v2/assetlogorond.png?v=20260915-brand-final3';
      favicon.type = 'image/png';
    }

    const logoLink = document.querySelector('header .logo');
    if (logoLink) {
      logoLink.innerHTML = '<img class="lrf-monogram-header" src="assets/brand-v2/assetlogorond.png?v=20260915-brand-final3" alt="LRF">';
    ...
    if (page === 'ouverture-compte.html' && clientBrand) {
      clientBrand.src = 'assets/brand-v2/assetlogorond.png?v=20260915-brand-final3';
      clientBrand.alt = 'LRF';
    }
