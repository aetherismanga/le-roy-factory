(() => {
  ...
  if (!document.getElementById('lrf-home-bg-controller-style')) {
    ...
    style.textContent = `
      ...
      .lrf-home-bg-controlled.lrf-home-light-mode .hero-logo-wrapper{filter:drop-shadow(0 7px 12px rgba(55,4,24,.22))!important}
      .lrf-home-bg-controlled.lrf-home-light-mode .hero-logo-wrapper::after{display:none!important}
      body.lrf-premium-v2 .lrf-home-bg-controlled.lrf-home-light-mode .hero-content h2{color:#681532!important;text-shadow:0 1px 0 #f7dfe6,0 2px 0 rgba(69,7,29,.20),0 4px 9px rgba(57,4,23,.18)!important}
      body.lrf-premium-v2 .lrf-home-bg-controlled.lrf-home-light-mode .hero-content p{color:#57132d!important;text-shadow:0 1px 0 rgba(255,255,255,.75),0 2px 5px rgba(63,6,27,.14)!important;font-weight:600!important}
      body.lrf-premium-v2 .lrf-home-bg-controlled.lrf-home-light-mode .btn-outline-white{color:#681532!important;border-color:#7e2444!important;background:rgba(255,248,245,.58)!important;text-shadow:none!important}
      .lrf-home-bg-controlled.lrf-home-light-mode .lrf-home-mode-toggle{color:#681532;text-shadow:0 1px 0 rgba(255,255,255,.65)}
      .lrf-home-bg-controlled.lrf-home-light-mode .lrf-screen-test-button{background:rgba(255,250,247,.46);border-color:rgba(104,21,50,.28);color:rgba(104,21,50,.72)}

      @media(max-width:900px){
        body.lrf-premium-v2 .lrf-home-bg-controlled.lrf-home-light-mode #lrf-open-search{padding:.78rem 1.35rem!important;font-size:.82rem!important}
  ...
  const syncLogo = () => {
    if (!heroLogo) return;
    const expected = mode === 'light' ? LOGOS.light : LOGOS.dark;
  ...
  const applyBackground = () => {
    ...
    hero.style.setProperty('background',`${light ? '#eee8df' : '#050505'} url("${image}") center center / cover no-repeat`,'important');
    ...
    if (overlay) {
      overlay.style.setProperty('background',light
