export const PARTNER_CONTACTS = {
  'Elios Ceramica': {
    ...
    contacts: [
      { name: 'Ghislaine Lebreton', role: 'Area Manager', email: 'glebreton@eliosceramica.it', phone: '+39 348 248 36 50' },
      { name: 'Caterina Toni', role: 'Commandes', email: 'ctoni@eliosceramica.it', phone: '+39 0536 842481' },
      { name: 'Giorgia Tisbo', role: 'Back-office', email: 'gtisbo@eliosceramica.it', phone: '' },
  ...
  'View Ceramica': {
    ...
    contacts: [
      { name: 'Alessio Garetti', role: 'Area Manager', email: 'alessio@viewceramiche.com', phone: '+39 345 384 5024' },
      { name: 'Maura', role: 'Commandes', email: 'maura@viewceramiche.com', phone: '+39 0536 80 80 29' },
  ...
  'Reviglass': { logo: 'assets/img/reviglass.png', contacts: [{ name: 'Service Export', role: 'Export', email: 'export@reviglass.es', phone: '' }] },
  ...
  'Bulbo': { logo: 'assets/img/bulbo.png', contacts: [
  ...
  'Randal Pro': { logo: 'assets/img/randal.png', contacts: [
  ...
  'Neobath': { logo: 'assets/img/neobath.png', contacts: [
  ...
  'Koibath': { logo: 'assets/img/koibath.png', contacts: [
  ...
  'Aquahome': { logo: 'assets/img/aquahome.png', contacts: [
  ...
  'Opal': { logo: 'assets/img/opal.png', contacts: [
    { name: 'Houda El Azouan', role: 'Après-vente / SAV', email: 'postventa@koibath.com', phone: '+34 617 439 852' },
    { name: 'Ruth Ballano', role: 'Commandes', email: 'pedidos@koibath.com', phone: '' },
    { name: 'María Antonia', role: 'Direction commerciale', email: 'direccioncomercial@koibath.com', phone: '' }
  ]},
...
export function primaryPartnerEmail(name) { return partnerContacts(name).find(c => c.email)?.email || ''; }
