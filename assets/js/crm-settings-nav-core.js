(() => {
  ...
  function loadClientPartnerAccess() {
    ...
    import('./crm-client-partner-access.js?v=20260918-togglefix1').catch(error=>{window.__LRF_CLIENT_PARTNER_ACCESS_LOADER__=false;console.error('Gestion partenaires client : chargement impossible',error)});
  }
