  ...
  function install() {
    ...
    card.innerHTML = `
      ...
      <div style="position:relative;z-index:2;padding-right:105px;">
        ...
        <p style="font-size:.9rem;color:#555;margin-bottom:1.5rem;">Robinetterie italienne et accessoires de salle de bain, du design contemporain aux collections classiques.</p>
      </div>
