(() => {
  ...
  style.textContent = `
    @keyframes cersaie26Sway{0%,100%{translate:-7px 0}50%{translate:7px 0}}
    .cersaie26-btn{border:1px solid rgba(255,211,85,.92);background:linear-gradient(145deg,#06281e,#0c4a35 72%,#082d22);color:#fff;box-shadow:0 0 18px rgba(35,196,123,.26),0 0 10px rgba(255,205,48,.16);cursor:pointer;transition:.2s;font-family:inherit;z-index:20;box-sizing:border-box}
    .cersaie26-btn:hover{transform:translateY(-2px) scale(1.02);box-shadow:0 0 30px rgba(35,196,123,.42),0 0 18px rgba(255,205,48,.28)}
    ...
    .cersaie26-desktop{position:absolute;right:clamp(28px,6vw,110px);top:48%;width:360px;height:150px;padding:24px 28px;border-radius:28px;text-align:left;box-shadow:0 0 34px rgba(35,196,123,.38),0 0 24px rgba(255,205,48,.24),0 18px 40px rgba(0,0,0,.28);animation:cersaie26Sway 5.8s ease-in-out infinite}
    .cersaie26-desktop strong{font-size:2rem;letter-spacing:.4px;margin-bottom:10px}.cersaie26-desktop small{font-size:1.05rem;line-height:1.5;margin-top:8px}
    .cersaie26-mobile{display:none;width:190px;min-width:190px;max-width:190px;min-height:68px;padding:10px 14px;border-radius:19px;text-align:center;margin-left:auto;margin-right:8px;box-shadow:0 0 24px rgba(35,196,123,.34),0 0 15px rgba(255,205,48,.22);animation:cersaie26Sway 5.4s ease-in-out infinite}
    ...
    @media(min-width:1500px){.cersaie26-desktop{width:420px;height:170px;padding:28px 32px;border-radius:30px}.cersaie26-desktop strong{font-size:2.3rem}.cersaie26-desktop small{font-size:1.15rem}}
    @media(max-width:1100px) and (min-width:901px){.cersaie26-desktop{width:300px;height:130px;padding:20px 22px;right:28px;top:48%}.cersaie26-desktop strong{font-size:1.7rem}.cersaie26-desktop small{font-size:.95rem}}
    ...
    @media(prefers-reduced-motion:reduce){.cersaie26-desktop,.cersaie26-mobile{animation:none!important}}
  `;
  ...
  modal.innerHTML=`<div class="cersaie26-box" role="dialog" aria-modal="true" aria-labelledby="cersaie26-title"><button class="cersaie26-close" aria-label="Fermer">×</button><h2 id="cersaie26-title">CERSAIE 2026</h2><div class="cersaie26-meta">21–25 SEPTEMBRE · BOLOGNE, ITALIE</div><p class="cersaie26-copy">Le Cersaie est le salon international de la céramique pour l’architecture et l’aménagement de salle de bains. Retrouvez LE ROY FACTORY à Bologne du 21 au 25 septembre 2026 sur les stands de nos partenaires.</p><div class="cersaie26-images"><div class="cersaie26-card"><b>Plan du salon</b><img data-cersaie26-img="plan" data-src="assets/img/cersaie%20plan%202026.png?v=20260902-original" loading="lazy" decoding="async" alt="Plan CERSAIE 2026"></div><div class="cersaie26-card"><b>Nos partenaires</b><img data-cersaie26-img="partners" data-src="assets/img/cersaie2026.png?v=20260902-original" loading="lazy" decoding="async" alt="Partenaires LE ROY FACTORY au CERSAIE 2026"></div></div><div class="cersaie26-actions"><button class="cersaie26-yes" data-answer="Je viens">Je viens</button><button class="cersaie26-no" data-answer="Je ne viens pas">Je ne viens pas</button></div><p class="cersaie26-note">✉ Réponse adressée à Coryne Le Roy et Jérôme Hugol.</p></div>`;
  ...
  const open=()=>{ensureImages();modal.classList.add('open');modal.setAttribute('aria-hidden','false');document.body.classList.add('cersaie26-lock')};
