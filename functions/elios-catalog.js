...
const ACTIVE=new Set(['roma',...Object.keys(lot1)]);
...
function publicCollection(value){const k=keyOf(value);if(k==='roma')return null;const c=lot1[k];if(!c)return null;return {key:k,collection:c.n,source:`Catalogue Général ELIOS 2026 · ${c.n} · pages ${c.p}`,colors:c.c||[],rows:(c.r||[]).map(unpackRow)}}
